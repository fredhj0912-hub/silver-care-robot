...
> **상태: Part 1 완료 (2026-09-07). Part 2 미착수.**
>
> **다음 세션 시작 방법** — 새 세션에서 이렇게 말하면 된다:
>
> ```
> docs/plan-quota-guard.md 의 Part 2(푸시투토크)를 읽고 그대로 실행해.
> ```
>
> **Part 2 는 파이 앞에서 확인이 필요하다** — 버튼이 720×1280 에서 누를 만한지, 그리고
> 이 변경이 **음성 응급 경로를 없앤다**는 사실(아래 안전 회귀 절)이 그 자리에서 체감된다.
>
